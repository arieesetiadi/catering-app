    ...
    <div class="row">
      <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">';?>
       <?php $limit = $item_artikel; 
        ...
        $query="SELECT post.post_id,post.post_title,post.seotitle,post.author,post.post_content,post.post_category,post.images,post.post_date,post.post_time,post.post_hits,user.fullname FROM post,user where post.author = user.user_id and post.post_status='1' order by post.post_id DESC LIMIT $offset, $limit";
        ...
        echo'<div class="col-xs-4 col-sm-4 col-md-6 col-lg-6">
                <article class="sw-blog-grid">
                    <div class="blog-featured-img">';
                      if ($images == NULL){   
                    echo'<img src="./timthumb?src='.$website_url.'/sw-content/sw-medium.jpg&h=140&w=300" alt="'.$post_title.'"/>';
                    } else {
                      echo'<img src="./timthumb?src='.$images.'&h=300&w=600" title="'.$post_title.'"/>';
                      }
                      echo'
                    </div>
