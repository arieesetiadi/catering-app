    ...
    punctuation: /[;[\]()`,.]/
        ...
        function d(a, b, d) {
            a.undoManager.transact(function() {
                var f = e(a);
                d = h.encode(d), f ? (a.dom.setAttrib(f, "class", "language-" + b), f.innerHTML = d, c.highlightElement(f), a.selection.select(f)) : (a.insertContent('<pre id="__new" class="line-numbers language-' + b + '">' + d + "</pre>"), a.selection.select(a.$("#__new").removeAttr("id")[0]))
            })
        }
        ...
        return {
            open: function(a) {
                a.windowManager.open({
                    ...
                    minHeight: Math.min(h.getViewPort().h, 400),
                    layout: "fit",
                    body: [{
                        type: "listbox",
                        name: "language",
