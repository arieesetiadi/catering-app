...
var App = function() {
    ...
    var uiInit = function() {
        ...
        // Initialize No Chosen
        $(".select-chosen-no-search").chosen({ width: "100%",disable_search_threshold: 10 }), 
...
var TablesDatatables = function () {
    return {
        init: function () {
            ...
            $(".dataTables_filter input").addClass("form-control").attr("placeholder", "Pencarian"), $(".dataTables_length select").addClass("form-control");
...
$('#form-validation').validate({
    ...
    messages: {
        ...
        folder: {
            required: 'Please enter a folder theme Location'
        },
        username: {
