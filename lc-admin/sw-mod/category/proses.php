...
// add
if ($modul=='category' AND $aksi=='add'){
$error = array();
...
$tambah= "INSERT INTO category(title,seotitle,type,parent_type) values('$title', '$seotitle', '2' ,'0')" or die($connection->error.__LINE__); 
...
// edit
elseif ($modul=='category' AND $aksi=='edit'){
 $error = array();
...
elseif ($modul=='category' AND $aksi=='multidelete'){
   $idArr = $_POST['item'];
        foreach($idArr as $id){
